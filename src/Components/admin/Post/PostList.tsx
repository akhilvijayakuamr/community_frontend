...
import { AllPostAdminData } from '../../../utils/interface/admin/home/postInterface';
import { AxiosResponse } from 'axios';
import { postAdminiListApi, postHide } from '../../../Api/api';
...
export const PostList: React.FC = () => {
    ...
    const handleHide = async (postId: string) => {
        try {
            const response: AxiosResponse<string> = await postHide(postId, headers);
